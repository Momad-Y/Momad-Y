...
<sub>A full RAG system with 3 swappable embedding backends and a choice of 2 Gemini models, or a fully offline <code>qwen3:8b</code> via Ollama when run locally.</sub>
